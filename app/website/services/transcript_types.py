...
DEFAULT_TRANSCRIPT_LAYOUT: TranscriptLayoutKeyT = "portrait_one"
...
TRANSCRIPT_LAYOUT_OPTIONS: tuple[TranscriptLayoutOptionT, ...] = (
    {
        "key": "portrait_one",
        "label": "Portrait - one grade column",
        "description": "Best default for official transcript review.",
        "orientation": "portrait",
        "column_count": 1,
        "css_class": "layout-portrait-one",
    },
    {
        "key": "portrait_two",
        "label": "Portrait - two grade columns",
        "description": "Compact portrait view for long transcripts.",
        "orientation": "portrait",
        "column_count": 2,
        "css_class": "layout-portrait-two",
    },
    {
        "key": "landscape_two",
        "label": "Landscape - two grade columns",
        "description": "Widest grade-table option.",
        "orientation": "landscape",
        "column_count": 2,
        "css_class": "layout-landscape-two",
    },
)

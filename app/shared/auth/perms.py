...
ROLE_MATRIX = {
    ...
    "cashier": {
        "add": ["courseinvoice", "studentsemesterinvoice", "payment"],
        "view": ["courseinvoice", "studentsemesterinvoice", "payment", "paymentmethod"],
    },
    "chair": {
        "add": ["course", "curricourse", "section"],
        "change": ["course", "curricourse", "section"],
        "view": [
            "academicyear",
            "college",
            "course",

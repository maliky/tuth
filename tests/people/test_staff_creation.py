...
def test_staff_creation_generates_username_when_missing() -> None:
    ...
    expected_username = mk_username("Tina", "Doe", prefix_len=1)
...
def test_staff_creation_can_set_custom_username() -> None:
    ...
    assert staff.user.username == "custom_staff"
...
def test_staff_creation_ensures_unique_username() -> None:
    ...
    expected_username = mk_username("Alex", "Smith", prefix_len=1)
    expected_username2 = mk_username("Ambroise", "Smith", prefix_len=1)

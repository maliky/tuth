# > Agent note: credentials compiled from app/shared/auth/helpers.py, app/shared/management/commands/test/create_test_users.py, app/shared/management/commands/test/reset_test_passwords.py, tests/people/fixture.py, tests/website/test_staff_permissions.py, and tests/selenium/test_portal_roles.py.
* Test user credentials (dev/test)
This section lists every explicit login/password pair defined in the repo for local dev and automated tests.
...
** Selenium portal role users (tests/selenium/test_portal_roles.py)
All of the accounts below share the same password: PassW0rd!
- instructor_user
- student_user
- chair_user
- dean_user
...
Command: python manage.py create_test_users
Password pattern (mk_password): <FIRST_INITIAL>-pass-P!

| Username                 | Password   | Role label                        |
|--------------------------+------------+-----------------------------------|
| test_donor               | D-pass-P!  | Donor                             |
| test_cashier             | C-pass-P!  | Cashier                           |
| test_student             | S-pass-P!  | Student                           |
| test_prospecting_student | P-pass-P!  | Prospecting Student               |
| test_staff               | S-pass-P!  | Staff                             |
| test_faculty             | F-pass-P!  | Faculty                           |
| test_chair               | C-pass-P!  | Chair                             |
| test_dean                | D-pass-P!  | Dean                              |
| test_vpaa                | V-pass-P!  | Vice President Academic Affairs   |
| test_enrollment          | E-pass-P!  | Enrollment                        |
| test_enrollment_officer  | E-pass-P!  | Enrollment Officer                |
| test_finance             | F-pass-P!  | Finance                           |
| test_finance_officer     | F-pass-P!  | Finance Officer                   |
| test_registrar           | R-pass-P!  | Registrar                         |
| test_registrar_officer   | R-pass-P!  | Registrar Officer                 |
| test_it                  | I-pass-P!  | It                                |

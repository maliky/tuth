...
Enrollement Desk create sutdent/news/ students/  should be removed to point direclty to the Adminj jump
 #+BEGIN_SRC plantuml :results file link :file Docs/view_routing_map2.png
@startuml
...
rectangle "Staff Dashboards\n(/staff/<role>/)" {
  [General Workspace] as StaffGeneral
  [Faculty Hub] as StaffFaculty
  [Chair Dashboard] as StaffChair
  [Dean Oversight] as StaffDean
  [VPAA Approval Hub] as StaffVPAA
  [Registrar Lifecycle Ops] as StaffRegistrar
  [Registrar Officer Console] as StaffRegistrarOfficer
  [Enrollment Desk] as StaffEnroll
  [Enrollment Officer Desk] as StaffEnrollOfficer
  [Finance & Holds] as StaffFinance
  [Finance Officer Control] as StaffFinanceOfficer
  [Cashier Station] as StaffCashier
  [Scholarship Office] as StaffScholarship
  [IT Support] as StaffIT
}
...
#+RESULTS:
[[file:Docs/view_routing_map2.png]]

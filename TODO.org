* <2025-11-11 mar. 20:58> correct dashboard test
...
* <2025-11-11 mar. 18:37> harmozize design
  look at [[file:journal.org::*Tusis Web Design Guide]] to propose an admin dashboard following same general theme.  Propose a color variation to mark that we are in the admin and only keep the mobile-first approach for the sutdent dashboard not for the staff dashboards.
  Insert you style guide propositions for student and staff below
